...
export declare namespace Graph {
    ...
    const registerNodeTool: {
        ...
        <K extends "button" | "boundary" | "button-remove">(name: K, entity: {
    ...
    const registerEdgeTool: {
        ...
        <K extends "button" | "vertices" | "boundary" | "button-remove" | "segments" | "source-anchor" | "target-anchor" | "source-arrowhead" | "target-arrowhead">(name: K, entity: {
            boundary: typeof import("../registry/tool/boundary").Boundary;
    ...
    const registerHighlighter: {
        ...
        <K extends "className" | "opacity" | "stroke">(name: K, entity: typeof import("../registry/highlighter/main")[K], force?: boolean | undefined): Registry.Highlighter.CommonDefinition;
    ...
    const registerPortLayout: {
        ...
        <K extends "ellipse" | "line" | "absolute" | "left" | "right" | "top" | "bottom" | "ellipseSpread">(name: K, entity: typeof import("../registry/port-layout/main")[K], force?: boolean | undefined): Registry.PortLayout.CommonDefinition;
    ...
    const registerPortLabelLayout: {
        ...
        <K extends "left" | "right" | "top" | "bottom" | "manual" | "outside" | "outsideOriented" | "inside" | "insideOriented" | "radial" | "radialOriented">(name: K, entity: typeof import("../registry/port-label-layout/main")[K], force?: boolean | undefined): Registry.PortLabelLayout.CommonDefinition;
    ...
    const registerMarker: {
        ...
        <K extends "circle" | "ellipse" | "path" | "block" | "async" | "classic" | "diamond" | "cross" | "circlePlus">(name: K, entity: typeof import("../registry/marker/main")[K], force?: boolean | undefined): Registry.Marker.Factory<KeyValue<any>>;
    ...
    const registerAnchor: {
        ...
        <K extends "left" | "right" | "top" | "bottom" | "center" | "topLeft" | "topRight" | "bottomLeft" | "bottomRight" | "orth" | "nodeCenter" | "midSide">(name: K, entity: typeof import("../registry/node-anchor/main")[K], force?: boolean | undefined): Registry.NodeAnchor.CommonDefinition;
    ...
    const registerEdgeAnchor: {
        ...
        <K extends "orth" | "closest" | "ratio" | "length">(name: K, entity: typeof import("../registry/edge-anchor/main")[K], force?: boolean | undefined): Registry.EdgeAnchor.CommonDefinition;
    ...
    const registerConnectionPoint: {
        ...
        <K extends "rect" | "bbox" | "boundary" | "anchor">(name: K, entity: typeof import("../registry/connection-point/main")[K], force?: boolean | undefined): Registry.ConnectionPoint.CommonDefinition;
...
export declare namespace Graph {
    ...
    const unregisterNodeTool: {
        <K extends "button" | "boundary" | "button-remove">(name: K): import("..").ToolsView.ToolItem.Definition | null;
        (name: string): import("..").ToolsView.ToolItem.Definition | null;
    };
    const unregisterEdgeTool: {
        <K extends "button" | "vertices" | "boundary" | "button-remove" | "segments" | "source-anchor" | "target-anchor" | "source-arrowhead" | "target-arrowhead">(name: K): import("..").ToolsView.ToolItem.Definition | null;
        (name: string): import("..").ToolsView.ToolItem.Definition | null;
    };
    ...
    const unregisterHighlighter: {
        <K extends "className" | "opacity" | "stroke">(name: K): Registry.Highlighter.CommonDefinition | null;
        (name: string): Registry.Highlighter.CommonDefinition | null;
    };
    const unregisterPortLayout: {
        <K extends "ellipse" | "line" | "absolute" | "left" | "right" | "top" | "bottom" | "ellipseSpread">(name: K): Registry.PortLayout.CommonDefinition | null;
        (name: string): Registry.PortLayout.CommonDefinition | null;
    };
    const unregisterPortLabelLayout: {
        <K extends "left" | "right" | "top" | "bottom" | "manual" | "outside" | "outsideOriented" | "inside" | "insideOriented" | "radial" | "radialOriented">(name: K): Registry.PortLabelLayout.CommonDefinition | null;
        (name: string): Registry.PortLabelLayout.CommonDefinition | null;
    };
    const unregisterMarker: {
        <K extends "circle" | "ellipse" | "path" | "block" | "async" | "classic" | "diamond" | "cross" | "circlePlus">(name: K): Registry.Marker.Factory<KeyValue<any>> | null;
    ...
    const unregisterAnchor: {
        <K extends "left" | "right" | "top" | "bottom" | "center" | "topLeft" | "topRight" | "bottomLeft" | "bottomRight" | "orth" | "nodeCenter" | "midSide">(name: K): Registry.NodeAnchor.CommonDefinition | null;
        (name: string): Registry.NodeAnchor.CommonDefinition | null;
    };
    const unregisterEdgeAnchor: {
        <K extends "orth" | "closest" | "ratio" | "length">(name: K): Registry.EdgeAnchor.CommonDefinition | null;
        (name: string): Registry.EdgeAnchor.CommonDefinition | null;
    };
    const unregisterConnectionPoint: {
        <K extends "rect" | "bbox" | "boundary" | "anchor">(name: K): Registry.ConnectionPoint.CommonDefinition | null;
