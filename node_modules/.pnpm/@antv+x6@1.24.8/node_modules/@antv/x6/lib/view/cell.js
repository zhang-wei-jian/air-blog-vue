...
var CellView = /** @class */ (function (_super) {
    ...
    CellView.getOptions = function (options) {
        var mergeActions = function (arr1, arr2) {
            if (arr2 != null) {
                return util_1.ArrayExt.uniq(__spreadArray(__spreadArray([], (Array.isArray(arr1) ? arr1 : [arr1])), (Array.isArray(arr2) ? arr2 : [arr2])));
            }
            return Array.isArray(arr1) ? __spreadArray([], arr1) : [arr1];
        };
