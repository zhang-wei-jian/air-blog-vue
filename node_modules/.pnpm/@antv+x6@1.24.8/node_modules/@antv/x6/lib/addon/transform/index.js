...
var Transform = /** @class */ (function (_super) {
    ...
    Transform.prototype.startResizing = function (evt) {
        ...
        util_2.notify('node:resize:mousedown', evt, view);
    };
    ...
    Transform.prototype.startRotating = function (evt) {
        ...
        this.startAction(evt);
        util_2.notify('node:rotate:mousedown', evt, view);
    };
            ...
            if (data.action === 'resizing') {
                ...
                if (!data.resized) {
                    if (view) {
                        ...
                        util_2.notify('node:resize', evt, view);
                    }
                    data.resized = true;
                }
                ...
                if (currentBBox.width !== width || currentBBox.height !== height) {
                    ...
                    util_2.notify('node:resizing', evt, view);
                }
                util_2.notify('node:resize:mousemove', evt, view);
            }
                ...
                if (!data.rotated) {
                    if (view) {
                        ...
                        util_2.notify('node:rotate', evt, view);
                    }
                    data.rotated = true;
                }
                ...
                if (currentAngle !== target) {
                    ...
                    util_2.notify('node:rotating', evt, view);
                }
                util_2.notify('node:rotate:mousemove', evt, view);
            }
        }
    };
    Transform.prototype.onMouseUp = function (evt) {
        ...
        if (data.action) {
            ...
            if (data.action === 'resizing') {
                util_2.notify('node:resize:mouseup', evt, view);
            }
            else if (data.action === 'rotating') {
                util_2.notify('node:rotate:mouseup', evt, view);
            }
        }
    };
    ...
    Transform.prototype.stopAction = function (evt) {
        ...
        if (view) {
            ...
            if (data.action === 'resizing' && data.resized) {
                util_2.notify('node:resized', evt, view);
            }
            else if (data.action === 'rotating' && data.rotated) {
                util_2.notify('node:rotated', evt, view);
            }
        }
    };
    return Transform;
