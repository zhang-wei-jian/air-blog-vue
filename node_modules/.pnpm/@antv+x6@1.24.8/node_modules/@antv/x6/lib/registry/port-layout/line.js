...
var line = function (portsPositionArgs, elemBBox, groupPositionArgs) {
    var start = util_1.normalizePoint(elemBBox, groupPositionArgs.start || elemBBox.getOrigin());
    var end = util_1.normalizePoint(elemBBox, groupPositionArgs.end || elemBBox.getCorner());
...
function lineLayout(portsPositionArgs, p1, p2, groupPositionArgs) {
    ...
    return portsPositionArgs.map(function (_a, index) {
        ...
        return util_1.toResult(p.round(), 0, offset);
    });
}
