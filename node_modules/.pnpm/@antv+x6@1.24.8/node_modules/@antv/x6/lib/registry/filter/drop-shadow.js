...
function dropShadow(args) {
    if (args === void 0) { args = {}; }
    var dx = util_1.getNumber(args.dx, 0);
    var dy = util_1.getNumber(args.dy, 0);
    var color = util_1.getString(args.color, 'black');
    var blur = util_1.getNumber(args.blur, 4);
    var opacity = util_1.getNumber(args.opacity, 1);
