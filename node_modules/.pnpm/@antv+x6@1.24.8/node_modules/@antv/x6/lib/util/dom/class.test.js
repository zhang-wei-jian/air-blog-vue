    ...
    describe('class', function () {
        describe('hasClass', function () {
            it('should return `false` when element or selector is null', function () {
                expect(class_1.hasClass(null, null)).toBe(false);
            });
            it('should return `false` for invalid element', function () {
                var text = document.createTextNode('');
                class_1.addClass(text, 'test');
                expect(class_1.hasClass(text, 'test')).toBe(false);
        ...
        describe('#addClass', function () {
            ...
            it('should call hook', function () {
                vel.addClass('test');
                vel.addClass(' ');
                class_1.addClass(vel.node, function (cls) { return cls + " foo"; });
        ...
        describe('#removeClass', function () {
            ...
            it('should call hook', function () {
                vel.removeClass();
                vel.addClass('foo bar');
                class_1.removeClass(vel.node, function (cls) { return cls.split(' ')[1]; });
                expect(vel.attr('class')).toEqual('foo');
            });
            it('should do nothing for invalid element or selector', function () {
                class_1.removeClass(null);
                class_1.removeClass(null, null);
            });
        });
        describe('#toggleClass', function () {
            var vel = vector_1.Vector.create('g');
            it('should do nothing for invalid element or selector', function () {
                class_1.toggleClass(null, 'foo');
                class_1.toggleClass(null, null);
            });
            ...
            it('should call hook', function () {
                vel.removeClass();
                class_1.toggleClass(vel.node, function () { return 'foo bar'; });
                expect(vel.attr('class')).toEqual('foo bar');
                class_1.toggleClass(vel.node, function () { return 'foo'; }, false);
                expect(vel.attr('class')).toEqual('bar');
            });
        });
    });
