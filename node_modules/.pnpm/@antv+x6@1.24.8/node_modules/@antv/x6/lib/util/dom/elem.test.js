    ...
    describe('elem', function () {
        ...
        describe('#ensureId', function () {
            ...
            it('should not overwrite if id exited', function () {
                ...
                var id = elem_1.ensureId(node);
                expect(node.id).toEqual(id);
                expect(elem_1.ensureId(node)).toEqual(id);
            });
        });
        ...
        describe('#isSVGGraphicsElement', function () {
            it('should return true when the given element is a SVGGraphicsElement', function () {
                expect(elem_1.isSVGGraphicsElement(vector_1.Vector.create('circle').node)).toBe(true);
                expect(elem_1.isSVGGraphicsElement(vector_1.Vector.create('rect').node)).toBe(true);
                expect(elem_1.isSVGGraphicsElement(vector_1.Vector.create('path').node)).toBe(true);
            });
            it('should return false when the given element is not a SVGGraphicsElement', function () {
                expect(elem_1.isSVGGraphicsElement()).toBe(false);
                expect(elem_1.isSVGGraphicsElement(vector_1.Vector.create('linearGradient').node)).toBe(false);
            });
        });
        ...
        describe('#tagName', function () {
            ...
            it('should return uppercase tagName when specified', function () {
                expect(elem_1.tagName(svgContainer, false)).toEqual('SVG');
            });
        });
        ...
        describe('#append', function () {
            var group = vector_1.Vector.create(elem_1.createElement('g'));
