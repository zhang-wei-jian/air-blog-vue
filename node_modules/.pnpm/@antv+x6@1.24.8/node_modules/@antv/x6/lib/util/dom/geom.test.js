...
describe('Dom', function () {
    describe('geom', function () {
        var _a = elem_test_1.setupTest(), svgContainer = _a.svgContainer, svgGroup = _a.svgGroup, svgGroup1 = _a.svgGroup1, svgCircle = _a.svgCircle, svgLinearGradient = _a.svgLinearGradient, svgEllipse = _a.svgEllipse, svgPolygon = _a.svgPolygon, svgRectangle = _a.svgRectangle, svgPath = _a.svgPath, foreignDiv = _a.foreignDiv;
        ...
        describe('#getBBox', function () {
            it('should return a rectangle instance', function () {
                ...
                expect(geom_1.getBBox(foreignDiv)).toBeInstanceOf(geometry_1.Rectangle);
            });
        });
