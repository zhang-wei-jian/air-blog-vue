    ...
    describe('matrix', function () {
        ...
        describe('createSVGTransform', function () {
            it('should return SVG transform object', function () {
                ...
                expect(matrix_1.createSVGTransform(matrix)).toBeInstanceOf(SVGTransform);
                expect(matrix_1.createSVGTransform({
                    a: 1,
                    b: 0,
                    c: 0,
                    d: 1,
        ...
        describe('#transformPoint', function () {
            ...
            it('should return the point unchanged when transformed without transformation', function () {
                var t = matrix_1.transformPoint(p, node.getCTM());
        ...
        describe('#transformLine', function () {
            var matrix = matrix_1.createSVGMatrix().translate(50, 50);
            ...
            it('should return the transformed line', function () {
                var l = matrix_1.transformLine(line, matrix);
        ...
        describe('#transformPolyline', function () {
            ...
            it('should return transformed polyline', function () {
                var _a, _b;
                var p = matrix_1.transformPolyline(polyline, matrix);
        ...
        describe('#parseTransformString', function () {
            it('should parse scale, rotate, translate', function () {
                var parsed = matrix_1.parseTransformString('scale(3) rotate(6) translate(9) xxx(11)');
            ...
            it('should parse martix', function () {
                var parsed = matrix_1.parseTransformString('matrix(1,0,0,1,30,30)');
        ...
        describe('#transformStringToMatrix', function () {
            ...
            arr.forEach(function (transformString) {
                it("should convert \"" + transformString + "\" to matrix", function () {
                    ...
                    expect(matrix_1.transformStringToMatrix(transformString)).toEqual(svgTestGroup.node.getCTM());
                });
            });
        });
        describe('#matrixToTransformString', function () {
            it('should return correct transformation string', function () {
                expect(matrix_1.matrixToTransformString()).toEqual('matrix(1,0,0,1,0,0)');
                expect(matrix_1.matrixToTransformString({ a: 2, d: 2 })).toEqual('matrix(2,0,0,2,0,0)');
                expect(matrix_1.matrixToTransformString({ a: 1, b: 2, c: 3, d: 4, e: 5, f: 6 })).toEqual('matrix(1,2,3,4,5,6)');
                expect(matrix_1.matrixToTransformString(matrix_1.createSVGMatrix({ a: 1, b: 2, c: 3, d: 4, e: 5, f: 6 }))).toEqual('matrix(1,2,3,4,5,6)');
                expect(matrix_1.matrixToTransformString({ a: 0, b: 1, c: 1, d: 0, e: 0, f: 0 })).toEqual('matrix(0,1,1,0,0,0)');
            });
        });
        describe('#matrixTo[Transformation]', function () {
            ...
            it('should convert matrix to rotation metadata', function () {
                var angle;
                angle = matrix_1.matrixToRotation(matrix_1.createSVGMatrix().rotate(45));
                expect(roundObject(angle)).toEqual({ angle: 45 });
                angle = matrix_1.matrixToRotation(matrix_1.createSVGMatrix().translate(50, 50).rotate(15));
                expect(roundObject(angle)).toEqual({ angle: 15 });
                angle = matrix_1.matrixToRotation(matrix_1.createSVGMatrix().translate(50, 50).rotate(60).scale(2));
                expect(roundObject(angle)).toEqual({ angle: 60 });
                angle = matrix_1.matrixToRotation(matrix_1.createSVGMatrix().rotate(60).rotate(60));
                expect(roundObject(angle)).toEqual({ angle: 120 });
            });
            it('should convert matrix to translation medata', function () {
                var translate;
                translate = matrix_1.matrixToTranslation(matrix_1.createSVGMatrix().translate(10, 20));
                expect(roundObject(translate)).toEqual({ tx: 10, ty: 20 });
                translate = matrix_1.matrixToTranslation(matrix_1.createSVGMatrix().translate(10, 20).rotate(10, 20).scale(2));
                expect(roundObject(translate)).toEqual({ tx: 10, ty: 20 });
                translate = matrix_1.matrixToTranslation(matrix_1.createSVGMatrix().translate(10, 20).translate(30, 40));
                expect(roundObject(translate)).toEqual({ tx: 40, ty: 60 });
            });
            it('should convert matrix to scaling metadata', function () {
                var scale;
                scale = matrix_1.matrixToScale(matrix_1.createSVGMatrix().scale(2));
                expect(roundObject(scale)).toEqual({ sx: 2, sy: 2 });
                scale = matrix_1.matrixToScale(matrix_1.createSVGMatrix()
                    .translate(15, 15)
                    .scaleNonUniform(2, 3)
                    .rotate(10, 20));
                expect(roundObject(scale)).toEqual({ sx: 2, sy: 3 });
                scale = matrix_1.matrixToScale(matrix_1.createSVGMatrix().scale(2, 2).scale(3, 3));
