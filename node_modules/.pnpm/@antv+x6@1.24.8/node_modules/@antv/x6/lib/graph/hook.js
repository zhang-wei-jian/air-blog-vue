    ...
    function hook(nullable, hookName) {
        return function (target, methodName, descriptor) {
            ...
            descriptor.value = function () {
                ...
                if (hook != null) {
                    this.getNativeValue = raw.bind.apply(raw, __spreadArray([this], args));
                    var ret = util_1.FunctionExt.call.apply(util_1.FunctionExt, __spreadArray([hook, this.graph], args));
                    this.getNativeValue = null;
                    if (ret != null || (nullable === true && ret === null)) {
                        return ret;
                    }
                }
                return raw.call.apply(raw, __spreadArray([this], args));
            };
        };
    }
    Decorator.hook = hook;
    function after(hookName) {
        return function (target, methodName, descriptor) {
            ...
            descriptor.value = function () {
                ...
                var ret = raw.call.apply(raw, __spreadArray([this], args));
                var hook = this.options[name];
                if (hook != null) {
                    ret = util_1.FunctionExt.call.apply(util_1.FunctionExt, __spreadArray([hook, this.graph], args)) && ret;
                }
                return ret;
            };
        };
