    ...
    describe('#normalizePathData', function () {
        ...
        it('should normalize path data', function () {
            paths.forEach(function (path) {
                if (path[1]) {
                    expect(normalize_1.normalizePathData(path[0])).toEqual(path[1]);
                }
                else {
                    normalize_1.normalizePathData(path[0]);
                }
            });
        });
        it('should parsed by Path', function () {
            var path1 = 'M 10 10';
            var normalizedPath1 = normalize_1.normalizePathData(path1);
            ...
            var normalizedPath2 = normalize_1.normalizePathData(path2);
            ...
            var normalizedPath3 = normalize_1.normalizePathData(path3);
