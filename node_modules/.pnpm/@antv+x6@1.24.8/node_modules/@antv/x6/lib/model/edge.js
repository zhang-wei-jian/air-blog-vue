...
var Edge = /** @class */ (function (_super) {
    ...
    Edge.prototype.getLabels = function () {
        var _this = this;
        return __spreadArray([], this.store.get('labels', [])).map(function (item) {
    ...
    Edge.prototype.getVertices = function () {
        return __spreadArray([], this.store.get('vertices', []));
    };
    ...
    Edge.prototype.getPolyline = function () {
        ...
        var vertices = this.getVertices();
        vertices.forEach(function (p) { return points.push(geometry_1.Point.create(p)); });
