...
var Cell = /** @class */ (function (_super) {
    ...
    Cell.prototype.getCommonAncestor = function () {
        ...
        return Cell.getCommonAncestor.apply(Cell, __spreadArray([this], cells));
    };
    ...
    Cell.prototype.addTools = function (items, obj, options) {
        ...
        if (tools == null || name == null || tools.name === name) {
            ...
            tools.name = name;
            tools.items = __spreadArray(__spreadArray([], tools.items), toolItems);
...
(function (Cell) {
    ...
    function deepClone(cell) {
        var cells = __spreadArray([cell], cell.getDescendants({ deep: true }));
